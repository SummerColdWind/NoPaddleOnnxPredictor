...
from nopaddle.postprocess import build_post_process
# from nopaddle.utils.logging import get_logger
from nopaddle.utils.utility import get_image_file_list, check_and_read
...
class TextRecognizer(object):
    def __init__(self, args):
        ...
        self.predictor, self.input_tensor, self.output_tensors, self.config = \
            utility.create_predictor(args, 'rec', None)
